...
{#if settingsDialog.open}
	...
	<!-- Dialog -->
	<div
		class="fixed inset-4 z-50 mx-auto flex max-h-[calc(100vh-2rem)] overflow-hidden rounded-xl border bg-background shadow-2xl lg:inset-12 lg:max-h-[calc(100vh-6rem)] lg:max-w-7xl"
